...
static void CheckUser()
{
    @try{
        ...
        PGresult *res = NULL;
        char command[] = "select * from check_user ($1, $2::bigint, $3::bigint, $4);";//Function exec
        const int nParams = 4;//Number of params
        ...
        paramValues[1] = (char*)@"2".UTF8String;//clientid
        paramLengths[1] = sizeof(paramValues[1]);//clientid
        paramFormats[1] = 0;//clientid
        
        paramValues[2] = (char*)@"0".UTF8String;//edituser
        paramLengths[2] = sizeof(paramValues[2]);//edituser
        paramFormats[2] = 0;//edituser
        
        paramValues[3] = (char*)@"".UTF8String;//ip
        paramLengths[3] = sizeof(paramValues[3]);//ip
        paramFormats[3] = 0;//ip
        
        const char *const paramValues2[] = {(char*)serial.UTF8String,(char*)@"2".UTF8String,(char*)@"0".UTF8String,(char*)@"".UTF8String};
        
//            int resultFormat = 0;
        
        res = PQprepare(_pgconn, "checkuser", command, nParams, NULL);
...
//                const char *const paramValues[] = {cid, name};
            res = PQexecPrepared(_pgconn, "checkuser", nParams, paramValues2, paramLengths,
                               paramFormats,0);
    ...
    @catch(NSException *e)
    {
        RegisterView *view = VIEW(RegisterView);
