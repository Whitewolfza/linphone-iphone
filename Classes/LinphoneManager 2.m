...
NSString *const kLinphoneMsgNotificationAppGroupId = @"group.za.clevercom.zenncomms2.msgNotification";
...
- (void)overrideDefaultSettings {
    ...
    //_configDb =  linphone_config_new_with_factory(@"linphonerc".UTF8String, factory.UTF8String);
...
+ (NSString *)cacheDirectory {
	LinphoneFactory *factory = linphone_factory_get();
	NSString *cachePath = [NSString stringWithUTF8String:linphone_factory_get_download_dir(factory, nil)];
	BOOL isDir = NO;
	NSError *error;
